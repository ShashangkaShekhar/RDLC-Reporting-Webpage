...
exports.PercentageTextboxValueAccessor = {
    provide: forms_1.NG_VALUE_ACCESSOR,
    useExisting: core_2.forwardRef(function () { return PercentageTextboxComponent; }),
    multi: true
};
var PercentageTextboxComponent = (function (_super) {
    __extends(PercentageTextboxComponent, _super);
    function PercentageTextboxComponent(el, cdRef, _ejIterableDiffers, _ejkeyvaluediffers) {
        var _this = _super.call(this, 'PercentageTextbox', el, cdRef, [], _ejIterableDiffers, _ejkeyvaluediffers) || this;
        _this.el = el;
        _this.cdRef = cdRef;
    ...
    PercentageTextboxComponent.prototype.writeValue = function (value) {
        if (this.widget) {
    ...
    PercentageTextboxComponent.prototype.registerOnChange = function (fn) {
        this.onChange = fn;
    };
    PercentageTextboxComponent.prototype.registerOnTouched = function (fn) {
        this.onTouched = fn;
    };
    return PercentageTextboxComponent;
}(core_1.EJComponents));
PercentageTextboxComponent.decorators = [
    { type: core_2.Component, args: [{
                selector: '[ej-percentagetextbox]',
                template: '',
                host: { '(ejchange)': 'onChange($event.value)', '(change)': 'onChange($event.value)', '(focusOut)': 'onTouched()' },
                providers: [exports.PercentageTextboxValueAccessor]
            },] },
];
/** @nocollapse */
PercentageTextboxComponent.ctorParameters = function () { return [
    { type: core_2.ElementRef, },
    { type: core_2.ChangeDetectorRef, },
    { type: core_2.IterableDiffers, },
    { type: core_2.KeyValueDiffers, },
]; };
PercentageTextboxComponent.propDecorators = {
...
exports.PercentageTextboxComponent = PercentageTextboxComponent;
exports.EJ_PERCENTAGETEXTBOX_COMPONENTS = [PercentageTextboxComponent
];
//# sourceMappingURL=percentagetextbox.component.js.map