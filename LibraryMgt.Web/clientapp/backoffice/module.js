...
var component_10 = require("./reportviewer/component");
var routes = [
    {
        path: '',
        ...
        children: [
            ...
            { path: 'reports/book', component: component_10.ReportViewerComponent }
        ]
    }
];
var BackofficeModule = /** @class */ (function () {
    ...
    BackofficeModule = __decorate([
        core_1.NgModule({
            imports: [common_1.CommonModule, http_1.HttpModule, forms_1.FormsModule, forms_1.ReactiveFormsModule, ej_angular2_1.EJAngular2Module.forRoot(), router_1.RouterModule.forChild(routes), angular_highcharts_1.ChartModule],
            declarations: [
                ...
                component_10.ReportViewerComponent
            ],
